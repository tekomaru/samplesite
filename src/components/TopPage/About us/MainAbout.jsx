...
export default function MainAbout() {
    const inviewAnimation = function(el, inview) {
        ...
        const ref = new useInView("ref",inviewAnimation);
return (
        <section id='about-us' className={styles.Company_wrapper___zoel}>
        <>
        <div className={styles.Company_companyTitle__hHkdJ}>
        <div className={styles.Company_companyHeadline__A55LA} ref={ref}>ABOUT US</div>
        </div>
        <div className={styles.Company_companyWrapper___7XfP}>
